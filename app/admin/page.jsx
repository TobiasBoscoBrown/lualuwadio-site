      ...
      <div className="acenter">
        ...
        {status === 'login' && (
          <form className="acard" onSubmit={login}>
            <div className="abrand">LUA<span>.</span>LUWADIO</div>
            <h1>Site editor</h1>
...
const CSS = `
.admin{--cream:#f6f2eb;--ink:#16110f;--ink-soft:#4a4036;--blue:#b00d17;--blue-deep:#840a11;--line:rgba(21,19,15,.16);background:var(--cream);color:var(--ink);min-height:100vh;font-family:'Archivo',system-ui,sans-serif}
